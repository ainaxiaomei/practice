                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Gate Server Information</div>
                                </div>
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" role="form" id="gateForm">
					                    <fieldset>
       ...
       <jsp:include page="common/commonFooter.jsp"></jsp:include>
        ...
        <script type="text/javascript">
	       ...
	       function modifyMcu(){
	        	$.ajax(
                 		{ type:"POST",
                 		  url:"<%=path%>/gateServerModify",
                 		  data:$("#gateForm").serialize(),
                 		  success:function(){
