        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gate Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="gateTable" class="table table-bordered table-hover">
                <thead>
                   <tr>
                     <th>Server Id</th>
                     <th>Server Name</th>
...
<!-- page script -->
        <script type="text/javascript">
           ...
           function addGateServer(){
        	   var returnVal=window.showModalDialog("<%=path%>/gateServerAdd","","dialogWidth=1000px;dialogHeight=600px");
           ...
           function modifyGateServer(){
        	   ...
        	   var returnVal=window.showModalDialog("<%=path%>/gateServerAdd",object,"dialogWidth=1000px;dialogHeight=600px");
        	   if(returnVal="success"){
        		   //刷新表格
        		   var table=$('#gateTable').DataTable(); 
             	  table.ajax.reload();
